...
if (isset($_GET['action'])) {
    if ($_GET['action'] == 'make_agency' && isset($_GET['id'])) {
        query('UPDATE `gr_users` SET agency = 1 WHERE id='.$_GET['id']);
    }
    if ($_GET['action'] == 'remove_agency' && isset($_GET['id'])) {
        query('UPDATE `gr_users` SET agency = 0 WHERE id='.$_GET['id']);
    }
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">All process list</h1>
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card mb-4">
